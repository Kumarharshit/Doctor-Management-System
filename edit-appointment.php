...
<!-- Mirrored from radixtouch.in/templates/admin/redstar/source/light/edit_appointment.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Jul 2018 05:26:53 GMT -->
<head>
    <meta charset="utf-8" />
	...
	<link href="assets/bootstrap/assets/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <!-- full calendar -->
                        	...
                        	<div class="chat-sidebar-list">
	                            <div class="chat-sidebar-chat-users slimscroll-style" data-rail-color="#ddd" data-wrapper-class="chat-sidebar-list">
	                                ...
	                                <ul class="media-list list-items">
	                                    <li class="media"><img class="media-object" src="assets/img/doc/doc3.jpg" width="35" height="35" alt="...">
	                                    ...
	                                    <li class="media">
	                                        ...
	                                        </div> <img class="media-object" src="assets/img/doc/doc1.jpg" width="35" height="35" alt="...">
	                                        <i class="busy dot"></i>
	                                        <div class="media-body">
	                                    ...
	                                    <li class="media"><img class="media-object" src="assets/img/doc/doc5.jpg" width="35" height="35" alt="...">
	                                        <i class="away dot"></i>
	                                        <div class="media-body">
	                                    ...
	                                    <li class="media">
	                                        ...
	                                        </div> <img class="media-object" src="assets/img/doc/doc4.jpg" width="35" height="35" alt="...">
	                                        <i class="online dot"></i>
	                                        <div class="media-body">
	                                    ...
	                                    <li class="media"><img class="media-object" src="assets/img/doc/doc2.jpg" width="35" height="35" alt="...">
	                                        <i class="busy dot"></i>
	                                        <div class="media-body">
	                                    ...
	                                    <li class="media"><img class="media-object" src="assets/img/doc/doc7.jpg" width="35" height="35" alt="...">
	                                        <i class="online dot"></i>
	                                        <div class="media-body">
	                                ...
	                                <ul class="media-list list-items">
	                                    <li class="media">
	                                        ...
	                                        </div> <img class="media-object" src="assets/img/doc/doc6.jpg" width="35" height="35" alt="...">
	                                    ...
	                                    <li class="media"><img class="media-object" src="assets/img/doc/doc8.jpg" width="35" height="35" alt="...">
	                                        <i class="offline dot"></i>
	                                        <div class="media-body">
	                                    ...
	                                    <li class="media">
	                                        ...
	                                        </div> <img class="media-object" src="assets/img/doc/doc9.jpg" width="35" height="35" alt="...">
	                                        <i class="offline dot"></i>
	                                        <div class="media-body">
	                                    ...
	                                    <li class="media"><img class="media-object" src="assets/img/doc/doc10.jpg" width="35" height="35" alt="...">
	                                        <i class="offline dot"></i>
	                                        <div class="media-body">
                            ...
                            <div class="chat-sidebar-item">
                                <div class="chat-sidebar-chat-user">
                                    ...
                                    <div class="chat-sidebar-chat-user-messages">
                                        ...
                                        <div class="post in">
                                            <img class="avatar" alt="" src="assets/img/doc/doc5.jpg" />
                                            <div class="message">
